...
ptm <- proc.time()
rankSurvey.DEdata=nmfEstimateRank(DEdata.mat,r=10:50,nrun=30,.options='t',seed=12345)
saveRDS(rankSurvey.DEdata,"rankSurvey2_45nrun30.Rds")
proc.time() - ptm
...
L=length(rankSurvey10_50nrun30$measures$rank)

x=rankSurvey10_50nrun30$measures$rank
y=rankSurvey10_50nrun30$measures$cophenetic[10:L]

z=rankSurvey10_50nrun30$measures$silhouette.basis
plot(x,z,type="l",col="magenta")
d=rankSurvey10_50nrun30$measures$dispersion

plot(rankSurvey10_50nrun30)
plot(rankSurvey10_50nrun30,"cophenetic")
plot(x,y,type="l")#,ylim=c(3,10))
lo <- loess(y~x) #Local Polynomial Regression Fitting
